...
public record PlayerInfoC2SPacket(int version) implements HypixelC2SPacket {
	...
	public static final PacketCodec<RegistryByteBuf, PlayerInfoC2SPacket> PACKET_CODEC = PacketCodec.tuple(
			PacketCodecs.VAR_INT, PlayerInfoC2SPacket::version, PlayerInfoC2SPacket::new
	);
