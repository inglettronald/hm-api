...
public record ErrorS2CPacket(CustomPayload.Id<HypixelS2CPacket> id, ErrorReason reason) implements HypixelS2CPacket {
	...
	public static final Function<CustomPayload.Id<HypixelS2CPacket>, PacketCodec<RegistryByteBuf, ErrorS2CPacket>> PACKET_CODEC = payloadId ->
			PacketCodec.tuple(
					PacketCodecs.indexed(ModApiErrorReason::tryResolveReason, ErrorReason::id),
